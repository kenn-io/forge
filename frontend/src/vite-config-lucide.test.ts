...
// @kenn-io/kit-ui is excluded from Vite's optimizer, so every lucide icon it
// imports is discovered lazily. A cold optimizer that meets an
...
describe("vite optimizeDeps lucide coverage", () => {
  it("pre-bundles every lucide icon the frontend imports", () => {
    ...
    // same icon imported directly from frontend source.
