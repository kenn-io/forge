...
describe("effectiveActivity", () => {
  it("uses newer workspace activity without changing the provider timestamp", () => {
    ...
    expect(effectiveActivity(providerAt, "2026-08-09T11:00:00Z", true)).toEqual({
  ...
  it("keeps provider activity authoritative when workspace recency is disabled", () => {
    expect(effectiveActivity("2026-08-09T10:00:00Z", "2026-08-09T11:00:00Z", false)).toEqual({
