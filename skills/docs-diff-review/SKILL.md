...
Serve the review directory on a free loopback port. Open the review URL and the
final rendered site in the user's browser. Before calling it ready, inspect at
least one changed page in a real browser and confirm that the page list, aligned
rows, screenshots, and "Open final page" link work.
