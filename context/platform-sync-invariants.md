...
- Startup reconciliation reopens legacy GitHub and GitLab archive lookups once when lifecycle details are missing. (`internal/db/queries_archive.go::RequeueArchiveLifecycleDetails`)
