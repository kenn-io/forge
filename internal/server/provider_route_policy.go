...
var providerRouteDeclarations = []ProviderRouteRule{
	...
	{OperationID: "send-devbox-initial-message", Owner: NodeLocal},
	{OperationID: "retry-devbox-workspace", Owner: NodeLocal},
	{OperationID: "rename-devbox-session", Owner: NodeLocal},
	{OperationID: "refresh-devbox-workspace", Owner: NodeLocal},
	{OperationID: "reconnect-devbox", Owner: NodeLocal},
	{OperationID: "push-devbox-workspace", Owner: NodeLocal},
	{OperationID: "pull-devbox-workspace", Owner: NodeLocal},
	{OperationID: "list-devbox-workspaces", Owner: NodeLocal},
	{OperationID: "list-devbox-connections", Owner: NodeLocal},
	{OperationID: "list-devbox-agent-sessions", Owner: NodeLocal},
	{OperationID: "launch-devbox-session", Owner: NodeLocal},
	{OperationID: "launch-devbox-handoff", Owner: NodeLocal},
	{OperationID: "get-devbox-workspace", Owner: NodeLocal},
	{OperationID: "get-devbox-runtime", Owner: NodeLocal},
	{OperationID: "get-devbox-files", Owner: NodeLocal},
	{OperationID: "get-devbox-file-preview", Owner: NodeLocal},
	{OperationID: "get-devbox-diff", Owner: NodeLocal},
	{OperationID: "get-devbox-commits", Owner: NodeLocal},
	{OperationID: "get-devbox-attach-spec", Owner: NodeLocal},
	{OperationID: "discover-devboxes", Owner: NodeLocal},
	{OperationID: "disconnect-devbox", Owner: NodeLocal},
	{OperationID: "delete-devbox-workspace", Owner: NodeLocal},
	{OperationID: "create-devbox-workspace", Owner: NodeLocal},
	{OperationID: "connect-devbox", Owner: NodeLocal},
	...
	{OperationID: "create-worker-workspace", Owner: NodeLocal},
