...
- Replacing an enrolled repository starts fresh discovery on the new internal
  ID; archive progress never crosses repository incarnations
  (`internal/db/queries.go::replaceRepoIncarnationTx`).
