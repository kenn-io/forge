...
func TestAPIPullsHideRemovedUpstreamArchiveRows(t *testing.T) {
	...
	require.EqualValues(t, 1, (*listed.JSON200)[0].Number)
	...
	require.Error(t, err)
	require.Equal(t, http.StatusNotFound, detail.StatusCode)
	...
	readPaths := map[string]func() (int, error){
		"commits": func() (int, error) {
			resp, requestErr := client.HTTP.GetPullCommitsWithResponse(ctx, &generated.GetPullCommitsRequestOptions{PathParams: &generated.GetPullCommitsPath{Provider: "gh", Owner: "acme", Name: "widget", Number: int64(2)}})
			return resp.StatusCode, requestErr
		},
		"diff": func() (int, error) {
			resp, requestErr := client.HTTP.GetPullDiffWithResponse(ctx, &generated.GetPullDiffRequestOptions{PathParams: &generated.GetPullDiffPath{Provider: "gh", Owner: "acme", Name: "widget", Number: int64(2)}, Query: &generated.GetPullDiffQuery{}})
			return resp.StatusCode, requestErr
		},
		"file preview": func() (int, error) {
			resp, requestErr := client.HTTP.GetPullFilePreviewWithResponse(ctx, &generated.GetPullFilePreviewRequestOptions{PathParams: &generated.GetPullFilePreviewPath{Provider: "gh", Owner: "acme", Name: "widget", Number: int64(2)}, Query: &generated.GetPullFilePreviewQuery{Path: &previewPath}})
			return resp.StatusCode, requestErr
		},
		"files": func() (int, error) {
			resp, requestErr := client.HTTP.GetPullFilesWithResponse(ctx, &generated.GetPullFilesRequestOptions{PathParams: &generated.GetPullFilesPath{Provider: "gh", Owner: "acme", Name: "widget", Number: int64(2)}})
			return resp.StatusCode, requestErr
		},
		"import metadata": func() (int, error) {
			resp, requestErr := client.HTTP.GetPullImportMetadataWithResponse(ctx, &generated.GetPullImportMetadataRequestOptions{PathParams: &generated.GetPullImportMetadataPath{Provider: "gh", Owner: "acme", Name: "widget", Number: int64(2)}})
			return resp.StatusCode, requestErr
		},
		"review draft": func() (int, error) {
			resp, requestErr := client.HTTP.GetPrReviewDraftWithResponse(ctx, &generated.GetPrReviewDraftRequestOptions{PathParams: &generated.GetPrReviewDraftPath{Provider: "gh", Owner: "acme", Name: "widget", Number: int64(2)}})
			return resp.StatusCode, requestErr
		},
		"stack": func() (int, error) {
			resp, requestErr := client.HTTP.GetPullStackWithResponse(ctx, &generated.GetPullStackRequestOptions{PathParams: &generated.GetPullStackPath{Provider: "gh", Owner: "acme", Name: "widget", Number: int64(2)}})
			return resp.StatusCode, requestErr
		},
	}
	...
	require.NoError(t, err)
	require.Equal(t, http.StatusOK, stacks.StatusCode)
	require.NotNil(t, stacks.JSON200)
	require.Len(t, *stacks.JSON200, 1)
	require.NotNil(t, (*stacks.JSON200)[0].Members)
	require.Len(t, (*stacks.JSON200)[0].Members, 1)
	require.EqualValues(t, 1, (*stacks.JSON200)[0].Members[0].Number)
}
...
func TestAPIActivityAndRepoSummariesHideRemovedUpstreamArchiveRows(t *testing.T) {
	...
	authors, err := client.HTTP.ListActivityAuthorsWithResponse(ctx, &generated.ListActivityAuthorsRequestOptions{Query: &generated.ListActivityAuthorsQuery{Since: &since}})
	require.NoError(err)
...
func TestAPIResolveAndAutocompleteHideOnlyRemovedUpstreamItems(t *testing.T) {
	...
	trigger, query := "#", ""
	autocomplete, err := client.HTTP.GetCommentAutocompleteWithResponse(ctx, &generated.GetCommentAutocompleteRequestOptions{PathParams: &generated.GetCommentAutocompletePath{Provider: "github", Owner: "acme", Name: "widget"}, Query: &generated.GetCommentAutocompleteQuery{Trigger: &trigger, Q: &query}})
	require.NoError(err)
...
func TestAPIRemovedIssueMutationsReturnNotFoundWithoutProviderWrites(t *testing.T) {
	...
	require.Empty(t, providerClient.Comments["acme/widget#7"])
	require.Equal(t, "original title", providerIssue.GetTitle())
	require.Equal(t, "original body", providerIssue.GetBody())
	require.Equal(t, "open", providerIssue.GetState())
}
...
func TestAPIRefreshPullCIHidesOnlyRemovedUpstreamItems(t *testing.T) {
	...
	client := setupTestClient(t, srv)
	visible, err := client.HTTP.RefreshPullCiWithResponse(ctx, &generated.RefreshPullCiRequestOptions{PathParams: &generated.RefreshPullCiPath{Provider: "github", Owner: "acme", Name: "widget", Number: int64(1)}})
	require.NoError(err)
	require.Equal(http.StatusOK, visible.StatusCode, string(visible.Body))
	removed, err := client.HTTP.RefreshPullCiWithResponse(ctx, &generated.RefreshPullCiRequestOptions{PathParams: &generated.RefreshPullCiPath{Provider: "github", Owner: "acme", Name: "widget", Number: int64(2)}})
	require.Error(err)
	require.NotNil(removed)
	require.Equal(http.StatusNotFound, removed.StatusCode, string(removed.Body))
	require.NotNil(removed.Error)
	require.Equal(
...
func TestAPIRemovedPullMutationsReturnNotFoundWithoutProviderWrites(t *testing.T) {
	...
	require.Empty(t, providerClient.Comments["acme/widget#7"])
	require.True(t, providerPR.GetDraft())
}
...
func TestAPISynchronousSyncRejectsRemovedUpstreamTombstones(t *testing.T) {
	...
	pull, err := client.HTTP.SyncPullWithResponse(ctx, &generated.SyncPullRequestOptions{PathParams: &generated.SyncPullPath{Provider: "github", Owner: "acme", Name: "widget", Number: int64(9)}})
	require.Error(err)
	require.NotNil(pull)
	require.Equal(http.StatusNotFound, pull.StatusCode, string(pull.Body))
	require.NotNil(pull.Error)
	require.Equal(
		generated.ProblemErrorCode("pullNotFound"),
		pull.Error.Code,
	)

	issue, err := client.HTTP.SyncIssueWithResponse(ctx, &generated.SyncIssueRequestOptions{PathParams: &generated.SyncIssuePath{Provider: "github", Owner: "acme", Name: "widget", Number: int64(10)}})
	require.Error(err)
	require.NotNil(issue)
	require.Equal(http.StatusNotFound, issue.StatusCode, string(issue.Body))
	require.NotNil(issue.Error)
	require.Equal(
...
func TestAPIIssuesHideRemovedUpstreamArchiveRows(t *testing.T) {
	...
	client := setupTestClient(t, srv)
	state := "all"
	listed, err := client.HTTP.ListIssuesWithResponse(ctx, &generated.ListIssuesRequestOptions{Query: &generated.ListIssuesQuery{State: &state}})
	require.NoError(err)
	...
	detail, err := client.HTTP.GetIssueWithResponse(ctx, &generated.GetIssueRequestOptions{PathParams: &generated.GetIssuePath{Provider: "gh", Owner: "acme", Name: "widget", Number: int64(2)}})
	require.Error(err)
...
func TestAPIListPullsAcceptsMixedCaseProviderQualifiedRepoFilter(t *testing.T) {
	...
	resp, err := client.HTTP.ListPullsWithResponse(t.Context(), &generated.ListPullsRequestOptions{Query: &generated.ListPullsQuery{Repo: &repo}})
	require.NoError(err)
	require.Equal(http.StatusOK, resp.StatusCode)
	require.NotNil(resp.JSON200)
	require.Len(*resp.JSON200, 1)
...
func TestAPIListPullsStateFilter(t *testing.T) {
	...
	state := "closed"
	resp, err = client.HTTP.ListPullsWithResponse(ctx, &generated.ListPullsRequestOptions{Query: &generated.ListPullsQuery{State: &state}})
	require.NoError(err)
...
func TestAPIListIssuesStateFilter(t *testing.T) {
	...
	state := "closed"
	resp, err = client.HTTP.ListIssuesWithResponse(ctx, &generated.ListIssuesRequestOptions{Query: &generated.ListIssuesQuery{State: &state}})
	require.NoError(err)
	require.Len(*resp.JSON200, 1)
...
func TestAPIListIssuesFilterByAssignee(t *testing.T) {
	...
	assignee := "alice"
	state := "all"
	resp, err := client.HTTP.ListIssuesWithResponse(ctx, &generated.ListIssuesRequestOptions{Query: &generated.ListIssuesQuery{
		Assignee: &assignee,
		State:    &state,
	}})
	require.NoError(err)
...
func TestAPIGetIssueIncludesAssignees(t *testing.T) {
	...
	resp, err := client.HTTP.GetIssueWithResponse(t.Context(), &generated.GetIssueRequestOptions{PathParams: &generated.GetIssuePath{Provider: "gh", Owner: "acme", Name: "widget", Number: int64(7)}})
	require.NoError(err)
	require.Equal(http.StatusOK, resp.StatusCode)
	require.NotNil(resp.JSON200)
...
func TestAPISyncIssuePersistsAssigneesFromProvider(t *testing.T) {
	...
	client := setupTestClient(t, srv)
	stateParam := "all"
	listResp, err := client.HTTP.ListIssuesWithResponse(ctx, &generated.ListIssuesRequestOptions{Query: &generated.ListIssuesQuery{State: &stateParam}})
	require.NoError(err)
	...
	assignee := "bob"
	filterResp, err := client.HTTP.ListIssuesWithResponse(ctx, &generated.ListIssuesRequestOptions{Query: &generated.ListIssuesQuery{Assignee: &assignee, State: &stateParam}})
	require.NoError(err)
