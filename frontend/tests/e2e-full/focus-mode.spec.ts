...
test.describe("focus mode", () => {
  ...
  test("narrow PR focus route shows actions only inside the actions menu", async ({
    ...
    await expect(
      page.locator(".actions-menu-popover").getByRole("button", { name: "Labels" }),
    ).toBeVisible();
  ...
  test("PR focus route keeps workspace inside the mid-narrow action grid", async ({
    ...
    await expect(
      page.locator(".actions-row--primary .primary-workspace-action .btn--workspace"),
    ).toBeVisible();
    await expect(page.locator(".actions-row--workspace")).toBeHidden();
    ...
    await page
      .locator(".actions-row--primary .primary-workspace-action .btn--workspace")
      .click();
    await expect(
      page.locator(".actions-row--primary .primary-workspace-action .action-error"),
