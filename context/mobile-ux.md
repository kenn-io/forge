...
- Routes retain local or Fleet identity. A missing workspace or ready runtime returns to the list; unavailable Fleet hosts and other failed terminal connections remain in context with Retry or reconnect affordances (`frontend/src/lib/components/mobile/MobileWorkspaceTerminal.svelte::readRuntime`).
