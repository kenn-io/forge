...
If startup reports a dirty failed migration, delete the database file and start
middleman again. Provider data will sync again. Local-only state such as stars,
kanban columns, and workspace links is lost.
