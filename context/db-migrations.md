...
- Do not add SQL `CHECK` constraints to enforce application invariants;
  express them in Go types and write-path validation (maintainer decision,
  `internal/db/types.go::ActiveRepo`).
