...
- Raw HTML image references to those generated screenshots must use site-root paths such as `/assets/generated/...`; `docs/zensical.toml` enables `use_directory_urls`, so `../assets/...` breaks on nested workflow pages.
