...
Call kenn_forge_list_repos first to learn valid repo filters, platform_repo_id values (the provider's integer repository ID), and sync freshness. Copy that integer ID into every later repository or item reference.
