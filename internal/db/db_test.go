...
func TestOpenMigratesNotificationSchemaFromVersion23(t *testing.T) {
	require := require.New(t)
	dir := t.TempDir()
	path := filepath.Join(dir, "notifications-v23.db")
...
func removeEventDirectURLColumnsForTest(raw *sql.DB) error {
	_, err := raw.Exec(`
