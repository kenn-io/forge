...
- Removed, moved, and explicitly classified inaccessible lookups are terminal; generic permission failures remain authentication retries. Canonical item content stays untouched. (`internal/archive/hydrate.go::archiveTerminalSyncOutcome`)
