  ...
  run: {
    tasks: {
      ...
      "kit-ui-check": {
        ...
        // Card/Checkbox/Toggle components (kit-ui #26) and flag ~30
        // pre-existing sites; re-enable rule by rule as those surfaces
        // migrate to the components. Keep the --disable list in sync with
        // frontend-check-no-deps in the Makefile.
